...
import com.yship.bean.UserExample.Criteria;
import com.yship.bean.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String countByExample(UserExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("hope_edu_user");
    ...
    public String insertSelective(User record) {
        ...
        if (record.getLogintime() != null) {
            sql.VALUES("loginTime", "#{logintime,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(UserExample example) {
        ...
        sql.SELECT("lastLoginDate");
        sql.SELECT("close");
        sql.SELECT("roleId");
        sql.SELECT("roleName");
        sql.FROM("hope_edu_user");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLogintime() != null) {
            sql.SET("loginTime = #{record.logintime,jdbcType=INTEGER}");
        }
        
        if (record.getLastlogindate() != null) {
            sql.SET("lastLoginDate = #{record.lastlogindate,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getLogintime() != null) {
            sql.SET("loginTime = #{logintime,jdbcType=INTEGER}");
        }
