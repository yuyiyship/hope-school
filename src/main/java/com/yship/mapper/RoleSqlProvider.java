...
import com.yship.bean.RoleExample.Criteria;
import com.yship.bean.RoleExample.Criterion;
...
public class RoleSqlProvider {
    ...
    public String countByExample(RoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("hope_edu_role");
